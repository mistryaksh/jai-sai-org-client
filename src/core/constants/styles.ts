...
export const COMPONENT_STYLES = {
     ...
     BUTTON_DANGER:
          "bg-red-500 text-white px-12 py-5 text-md font-light tracking-wider focus:outline-none active:outline-none",
};
...
export const MISSION_CARD_STYLES = {
     ...
     DESCRIPTION:
          "text-xs sm:text-sm font-light tracking-wide sm:tracking-wider text-slate-500 leading-loose mt-5 text-center group-hover:text-white ease-in-out duration-200",
};
...
export const CAUSE_CARD_STYLES = {
     ...
     TITLE: "text-2xl text-blue-950 font-semibold capitalize tracking-wide mb-6 sm:mb-10 sm:mt-0 hover:text-emerald-500 cursor-pointer ease-in-out duration-200 truncate",
     SUB_TITLE: "text-sm text-slate-400 font-light capitalize tracking-wide mb-2 truncate",
     DESCRIPTION: "text-xs text-slate-500 font-light capitalize h-full",
